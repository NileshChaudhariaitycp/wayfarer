...
import com.wayfarer.hotel.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInsufficientRooms(InsufficientRoomsException ex, HttpServletRequest req) {
