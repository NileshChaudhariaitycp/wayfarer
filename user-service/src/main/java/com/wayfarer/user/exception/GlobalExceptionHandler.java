...
import com.wayfarer.user.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    // @PreAuthorize failures throw this from inside the controller call, which
    // Spring MVC's exception resolution intercepts before it can reach Spring
    // Security's own ExceptionTranslationFilter — without this handler it falls
    // through to handleUnexpected() below and wrongly returns 500 instead of 403.
